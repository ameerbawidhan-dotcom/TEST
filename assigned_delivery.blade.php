                    ...
                    @foreach ($assigned_deliveries as $key => $delivery)
                        <tr>
                            ...
                            <td class="text-secondary" style="vertical-align: middle;">
                                <!-- ? تصحيح وقراءة الحقل التاريخي القياسي المستقر لمنع الانهيارات والخطأ 500 نهائياً -->
                            ...
                            <td style="vertical-align: middle;">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input onchange="update_status(this)" value="{{ $delivery->id }}" type="checkbox" @if($delivery->delivery_status == 'picked_up') checked @endif>
